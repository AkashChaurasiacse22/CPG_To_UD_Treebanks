...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = r"D:\Lab Work\BTP\application_default_credentials.json"
...
if __name__ == "__main__":
    ...
    parser.add_argument("-sd", "--source_directory", type=str, required=True, help="Path to the source directory containing text files.")
    parser.add_argument("-td", "--target_directory", type=str, required=True, help="Path to the target directory for translated files.")
